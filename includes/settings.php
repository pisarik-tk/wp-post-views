...
class Wp_post_view_settings
{
	...
	public static function select_post_type_callback(  ) {
		...
		?>
		<label for=""><?php _e("Posts", 'wppv'); ?> </label>
		...
		<label for=""><?php _e("Pages", 'wppv'); ?> </label><input type='checkbox' name='wppv_api_settings[wppv_api_post_checkbox_1][page]' value="page" <?php checked( (  isset($checkbox_val['page']) && 'page' == @$checkbox_val['page']), true ); ?>>
		<?php
